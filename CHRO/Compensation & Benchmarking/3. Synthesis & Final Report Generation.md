# Report Creation
This JSON object defines the agent's persona, its specific task, the required input variables, a step-by-step set of instructions, and the expected output format.
